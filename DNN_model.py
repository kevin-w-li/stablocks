...
IMAGE_SIZE = DNN_input.IMAGE_SIZE
NUM_GRID_LINES = DNN_input.NUM_GRID_LINES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = DNN_input.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = DNN_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
...
def inference(images):
  ...
  with tf.variable_scope('softmax_linear') as scope:
    weights = _variable_with_weight_decay('weights', [192, NUM_GRID_LINES],
...
def _add_loss_summaries(total_loss):
  """Add summaries for losses in Blocks model.
